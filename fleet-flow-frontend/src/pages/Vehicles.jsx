                        ...
                        {otherStatuses.length > 0 ? (
                            <>
                                ...
                                {otherStatuses.map(s => (
                                    <button
                                        key={s}
                                        onClick={() => { onStatusChange(vehicle.id, s); setOpen(false); }}
    ...
    return (
        <div className="space-y-5">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                <div>
                    <h1 className="text-xl sm:text-2xl font-bold text-slate-900">Vehicle Registry</h1>
                    <p className="text-slate-500 text-sm">Manage your fleet assets and status</p>
                </div>
                <button
