...
import { User, Mail, Lock, Briefcase, Home, Eye, EyeOff } from 'lucide-react';
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (registeredUser.role === 'FLEET_MANAGER') {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4 relative">
            <Link 
                to="/" 
                className="absolute top-6 left-6 text-white hover:text-primary-400 flex items-center gap-2 transition-colors font-medium bg-slate-800/50 hover:bg-slate-800 px-4 py-2 rounded-full"
            >
                <Home size={18} />
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            <input
                                ...
                                onChange={handleChange}
                                className="w-full px-4 py-2 pr-10 text-gray-900 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all"
                                placeholder="••••••••"
                            />
                            <button
                                type="button"
